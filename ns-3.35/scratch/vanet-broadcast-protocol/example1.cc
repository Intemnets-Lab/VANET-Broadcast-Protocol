...
//     //Experiment 1 & 2 - Set TBA either to left or to right of caravan (see vbp.SetBroadcastArea() a few lines above)
//     float vehicleDistance = 50;
//     float vehicleSpeed = 15; //traffic levels: low 5, medium 15, high 30
